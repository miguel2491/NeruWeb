...
<input type="hidden" id="url_listado" value="{{ url('variables/listado') }}">
<input type="hidden" id="url_datosget" value="{{ url('variables/datos') }}">
<input type="hidden" id="url_guardar" value="{{ url('variables/guardar') }}">
<input type="hidden" id="url_actualizar" value="{{ url('variables/update') }}">
<input type="hidden" id="url_eliminar" value="{{ url('variables/delete') }}">
		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<div class="row">
						<div class="col-md-7">
							<h5><i class="glyphicon glyphicon-align-justify"></i> Variables Neru</h5>
						</div>
            <div class="col-md-5">
...
@section('main-scripts')
	...
	<script src="{{ asset('js/test/variables.js') }}"></script>
@endsection
