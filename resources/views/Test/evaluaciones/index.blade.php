...
<input type="hidden" id="url_listado" value="{{ url('evaluaciones/listado') }}">
<input type="hidden" id="url_datosget" value="{{ url('evaluaciones/datos') }}">
<input type="hidden" id="url_guardar_eva" value="{{ url('evaluaciones/guardar') }}">
<input type="hidden" id="url_actualizar" value="{{ url('evaluaciones/update') }}">
<input type="hidden" id="url_eliminar" value="{{ url('evaluaciones/delete') }}">
		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<div class="row">
						<div class="col-md-7">
							<h5><i class="glyphicon glyphicon-align-justify"></i> Evaluaciones Neru</h5>
						</div>
            <div class="col-md-5">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="ModalEditar">Evaluaciones</h4>
			</div>
...
@section('main-scripts')
	...
	<script src="{{ asset('js/test/evaluacion.js') }}"></script>
@endsection
