$(document).ready(function() {
    ...
    $("#variable_actividad").val(0).change();
    ...
    dataTable_datos =
        $("#table-datos").dataTable({
            ...
            "aoColumns": [{
                ...
                "mData": "valor_resultado",
                "bSortable": true,
                "mRender": function(data, type, full) {
                    var valor_resultado = full.valor_resultado;
                ...
                "bSortable": true,
                "mRender": function(data, type, full) {
                    var valor_minimo = full.valor_minimo;
                    return valor_minimo;
                }
            }, {
                "mData": "duracion",
                ...
                "bSortable": false,
                "mRender": function(data, type, full) {
                    var bttnDelete = '<button class="btn btn-danger btn-xs" id="bttn_modal_delete" data-id="' + full.id_actividad + '" data-target="#modal_delete"  data-toggle="modal" title="Eliminar"><i class="glyphicon glyphicon-trash"></i></button>';
