    ...
    dataTable_datos =
        $("#table-datos").dataTable({
            ...
            "aoColumns": [{
                ...
                "bSortable": false,
                "mRender": function(data, type, full) {
                    var bttnDelete = '<button class="btn btn-danger btn-xs" id="bttn_modal_delete" data-id="' + full.id_variable + '" data-target="#modal_delete"  data-toggle="modal" title="Eliminar"><i class="glyphicon glyphicon-trash"></i></button>';
                    var bttnUpdate = '<button class="btn btn-warning btn-xs" id="bttn_modal_update"  data-id="' + full.id_variable + '"  data-target="#ModalSave" data-toggle="modal" title="Editar"><i class="glyphicon glyphicon-edit"></i></button> ';
        ...
        if (id != 0) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var obj = data;
                    $('#id_variable').val(obj[0].id_variable);
                    $('#nombre').val(obj[0].nombre);
                    $('#subtitulo').val(obj[0].subtitulo);
                    $('#ejemplo').val(obj[0].ejemplo);
                    $('#descripcion').val(obj[0].descripcion);
                    $("input[name=active]").iCheck(obj[0].status == 1 ? 'check' : 'uncheck');
                }
